...
//        	}
	...
	var addData = function() {
		window.location.href = "/authority/permission/saveUI";
	}
	...
	var updateData = function() {
		...
		window.location.href = "/authority/permission/saveUI?id="+list[0]["id"];
	}
...
//        }
		...
		layer.confirm("确定要删除该数据吗?", {
			...
			$.ajax({
				"type" : "GET",
				"url" : "/authority/permission/delete/" + list[0]["id"],
				"dataType" : "json",
