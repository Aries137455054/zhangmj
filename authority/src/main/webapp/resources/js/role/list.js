$(function() {
	...
	var setPermission = function() {
        ...
        $.ajax({
			"type" : "GET",
			"url" : "/authority/permission/getPermissionListWithChecked/" + list[0].id,
			"dataType" : "json",
					...
					layer.open({
			    	  ...
			    	  yes: function(index, layero){
			              ...
			              if (nodes.length > 0) {
			        	    ...
			        	    $.ajax({
			    				"type" : "POST",
			    				"url" : "/authority/role/setPermission",
...
//			    					}
	...
	var addData = function() {
		window.location.href = "/authority/role/saveUI";
	}
	...
	var updateData = function() {
		...
		window.location.href = "/authority/role/saveUI?id="+list[0]["id"];
	}
	...
	var deleteData = function() {
		...
		layer.confirm("确定要删除该数据吗?", {
			...
			$.ajax({
				"type" : "GET",
				"url" : "/authority/role/delete/" + ids.join(","),
				"dataType" : "json",
				"success" : function(resp) {
					if (resp.code == 200) {
						layer.close(index);
