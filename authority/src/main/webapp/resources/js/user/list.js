$(function() {
	...
	var setRole = function() {
     ...
     // 发送请求
	    $.ajax({
			"type" : "GET",
			"url" : "/authority/role/getRoleListWithSelected/"+list[0].id,
			"dataType" : "json",
...
//				    					}
	...
	var addData = function() {
		window.location.href = "/authority/user/saveUI";
	}
	...
	var updateData = function() {
		...
		window.location.href = "/authority/user/saveUI?id="+list[0]["id"];
	}
	...
	var deleteData = function() {
		...
		layer.confirm("确定要删除该数据吗?", {
			...
			$.ajax({
				"type" : "GET",
				"url" : "/authority/user/delete/" + ids.join(","),
				"dataType" : "json",
				"success" : function(resp) {
					if (resp.code == 200) {
						layer.close(index);
