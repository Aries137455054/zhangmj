...
<link rel="stylesheet" href="/authority/resources/css/font-awesome.min.css" />
<link rel="stylesheet" href="/authority/resources/css/ace.min.css" />
<link rel="stylesheet" href="/authority/resources/js/layer/skin/default/layer.css" />
</head>
<body>
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form id="save-form" class="form-horizontal" role="form" action="/authority/permission/save" method="post">
...
<!-- 								<option value="0"></option> -->
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select class="col-xs-10 col-sm-8" name="type" id="type">
								<option value="1" ${permission.type == 1 ? 'selected':'selected' }>目录</option>
	...
	<script src="/authority/resources/js/jquery-1.11.3.js"></script>
	<script src="/authority/resources/js/layer/layer.js"></script>
	<script src="/authority/resources/js/permission/saveUI.js"></script>
</body>
</html>