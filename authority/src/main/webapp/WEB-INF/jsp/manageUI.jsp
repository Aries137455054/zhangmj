...
<link rel="stylesheet" href="/authority/resources/css/ace-rtl.min.css" />
<link rel="stylesheet" href="/authority/resources/css/ace-skins.min.css" />
</head>
...
<body>
				...
				<ul class="nav ace-nav">
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							src="/authority/resources/images/user.png" alt="Jason's Photo" />
							<span class="user-info"> <small>欢迎,</small>${sessionScope.loginUser.userName}
	...
	<script src="/authority/resources/js/bootstrap.min.js"></script>
