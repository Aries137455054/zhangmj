$(function() {
	...
	var tableObj = commonUtil.initTable({
		treeShowField: 'name',
        url : "/authority-shiro/permission/list",
        search : true,
        detailView : true,
        pagination : true,	
        //pageSize : 10,
...
//        	}
	...
	var addData = function() {
		window.location.href = "/authority-shiro/permission/saveUI";
	}
	...
	var updateData = function() {
		...
		window.location.href = "/authority-shiro/permission/saveUI?id="+list[0]["id"];
	}
...
//        }
		...
		layer.confirm("确定要删除该数据吗?", {
			...
			$.ajax({
				"type" : "GET",
				"url" : "/authority-shiro/permission/delete/" + list[0]["id"],
				"dataType" : "json",
