...
<link rel="stylesheet" href="/authority-shiro/resources/js/layer/skin/default/layer.css" />
</head>
<body>
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form id="save-form" class="form-horizontal" role="form" action="/authority-shiro/permission/save" method="post">
...
<!-- 								<option value="0"></option> -->
	...
	<script src="/authority-shiro/resources/js/layer/layer.js"></script>
	<script src="/authority-shiro/resources/js/permission/saveUI.js"></script>
</body>
</html>