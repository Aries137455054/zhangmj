...
<body>
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form id="save-form" class="form-horizontal" role="form" action="/authority-shiro/user/save" method="post">
	...
	<script src="/authority-shiro/resources/js/user/saveUI.js"></script>
</body>
</html>