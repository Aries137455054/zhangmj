...
<html lang="zh">
	...
	<body class="login-layout">
		...
		<script type="text/javascript" src="/authority-shiro/resources/js/jquery-1.11.3.js"></script>
		<script type="text/javascript" src="/authority-shiro/resources/js/login.js"></script>
</body>
</html>